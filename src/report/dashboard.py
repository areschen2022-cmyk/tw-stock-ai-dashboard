...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    body { margin:0; font-family: "Segoe UI", Arial, sans-serif; color:var(--ink); background:#eef3f8; line-height:1.45; }
    header { padding:18px 24px 14px; border-bottom:1px solid rgba(255,255,255,.08); background:#0b1220; color:#fff; box-shadow:0 14px 30px rgba(15,23,42,.18); }
    ...
    .action-panel { border:1px solid #b7e4cf; border-top:4px solid var(--good); padding:16px; box-shadow:0 12px 30px rgba(15,118,73,.08); }
    ...
    .decision-summary-compact { border:1px solid var(--line); border-radius:10px; padding:10px; background:#fbfcfe; }
    ...
    .risk-panel { border:1px solid #fecdd6; border-top:4px solid var(--bad); }
    ...
    .toolbar { display:flex; gap:10px; align-items:center; margin:12px 0; flex-wrap:wrap; padding:10px; background:rgba(255,255,255,.9); border:1px solid var(--line); border-radius:12px; position:sticky; top:58px; z-index:12; backdrop-filter:blur(10px); box-shadow:var(--shadow-sm); }
