...
foreach ($name in @("debug_data.json", "backtest_review.json", "weekly_review.json", "backtest_30y.json", "kronos_proxy_backtest.json", "cloud_skill_routes_status.json", "schedule_health.json")) {
